                        ...
                        <div className="col focus">
                            ...
                            <div className="carousel slide text-left" data-ride="carousel" id="carousel-1">
                                <div className="carousel-inner">
                                    <div className="carousel-item active"><Slide path="assets/img/home_vietnam1.jpg" content="KHÔNG THAY ĐỔI CHIẾN LƯỢC CHỐNG DỊCH, THỰC HIỆN NGHIÊM 5K." small_date="10/05/2021 17:10)" small_text="Không một quốc gia nào an toàn khi cả thế giới chưa an toàn. Không một người Việt Nam nào an toàn khi cả nước chưa an toàn. Mỗi người phải trách nhiệm trước hết với mình và người thân của mình, sau đó là với đất nước, với cộng đồng..." /></div>
